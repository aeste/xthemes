...
function aeste_dp_settings($saved_settings, $subtheme_defaults = array()) {

  // Get the default values from the .info file.
  $defaults = aeste_dp_theme_get_default_settings('basic');
  ...
  $form['aeste_dp_block_editing'] = array(
    ...
    '#default_value' => $settings['aeste_dp_block_editing'],
    '#prefix'        => '<strong>' . t('Block Edit Links:') . '</strong>',
  );

  $form['themedev']['aeste_dp_rebuild_registry'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry on every page.'),
    '#default_value' => $settings['aeste_dp_rebuild_registry'],
...
function _aeste_dp_theme(&$existing, $type, $theme, $path) {
  ...
  aeste_dp_theme_get_default_settings($theme);
...
function aeste_dp_theme_get_default_settings($theme) {
  $themes = list_themes();
